...
sys.path.append('/home/naimul/human-skills/skills/architecture-auditing-linter/scripts')
sys.path.append('/home/naimul/human-skills/skills')
...
print("TEST_CASES = [")
for case in test_codes:
    score = tool.evaluate(None, case["code"])
    print("    {")
    print(f"        'id': '{case['id']}',")
    print(f"        'description': '{case['description']}',")
    print(f"        'expected_score': {score:.4f},")
