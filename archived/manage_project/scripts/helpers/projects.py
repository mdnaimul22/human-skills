...
from . import files, dirty_json, persist_chat, file_tree
...
def activate_project(context_id: str, name: str, *, mark_dirty: bool = True):
    ...
    if mark_dirty:
        from .state_monitor_integration import mark_dirty_all
...
def save_project_secrets(name: str, secrets: str):
    from .secrets import get_project_secrets_manager
