...
- **`src/core/`**: Only knows `src/schema/__init__.py` and `src/config/__init__.py`.
- **`src/services/`**: Only knows `src/core/__init__.py`, `src/schema/__init__.py`, and `src/config/__init__.py`.
...
## 3. Coding Guidelines (Safety, Performance, Security)
...
## 4. Code Craftsmanship & Maintenance

### 4.1 Advanced Refactoring & Code Evolution
